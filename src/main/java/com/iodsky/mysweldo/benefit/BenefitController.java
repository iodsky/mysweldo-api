...
public class BenefitController {
    ...
    @Operation(summary = "Create benefit", description = "Create a new benefit. Requires PAYROLL role.", operationId = "createBenefit")
    public BenefitDto createBenefitType(@Valid @RequestBody BenefitRequest request) {
        Benefit benefit = service.createBenefit(request);
        return mapper.toDto(benefit);
    }

    @GetMapping
    @Operation(summary = "Get all benefit", description = "Retrieve all benefit with pagination. Requires PAYROLL or HR role.", operationId = "getAllBenefits")
    public PageDto<BenefitDto> getAllBenefitTypes(
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get benefit type by code", description = "Retrieve a specific benefit. Requires PAYROLL or HR role.", operationId = "getBenefitById")
    public BenefitDto getBenefitTypeById(
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Update benefit", description = "Update an existing benefit. Requires PAYROLL role.", operationId = "updateBenefit")
    public BenefitDto updateBenefitType(
            @Parameter(description = "Benefit code") @PathVariable String id,
